        ...
        wp.customize('header_textcolor', function(value) {
            value.bind(function(to) {
                if (to) {
                    ...
                    $('.header .cmn-toggle-switch.active:before, .header .cmn-toggle-switch.active:after, .header .cmn-toggle-switch span:before, .header .cmn-toggle-switch span:after, .header .cmn-toggle-switch span').css({
                        'background': to
                    });
